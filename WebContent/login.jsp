		...
		<TR>
			<TD>
				<TABLE width="100%" border="0" cellspacing="1" cellpadding="1"
					...
					<TR>
						<TD colspan="2">Nickname <B><%=n%></B> has already been taken
							please select some other nickname.
						</TD>
					</TR>
				</TABLE>
			</TD>
				...
				<TABLE width="100%" border="0" cellspacing="1" cellpadding="1"
					...
					<TR>
						<TD colspan="2"><b>Sex</b> and <b>Nickname</b> must be
							entered and nickname must be atleast <b>4</b> characters long and
			...
			<TD colspan="2" class="panel">
				<FORM name="login" method="post"
					...
					<TABLE width="100%" border="0">
						<TR>
							<TD width="30%" class="white">Nickname</TD>
							<TD width="70%"><INPUT type="text" name="nickname" size="15">
							</TD>
						</TR>
						<TR>
							<TD width="30%" class="white">Sex</TD>
							<TD width="70%"><SELECT size="1" name="sex">
