...
<%@ page isErrorPage="false" errorPage="error.jsp"
	import="java.util.Set,java.util.Iterator,java.util.Map,chatroom.services.*,chatroom.helper.*;"%>
<%
...
<TITLE>Edit your (<%=chatter.getName()%>'s) Information
</TITLE>
...
<BODY bgcolor="#FFFFFF">
	<div align="center">
		<center>
			<FORM name="chatterinfo" method="post"
				action="<%=request.getContextPath()%>/servlet/saveInfo">
				<TABLE width="80%" border="0" cellspacing="0" cellpadding="2"
					align="center" bordercolor="#6633CC">
					<TR>
						<TD valign="top"><h4>Nickname:</h4></TD>
						<TD valign="top"><%=chatter.getName()%></TD>
						<input type="hidden" name="nickname"
							value="<%=chatter.getName()%>">
					</TR>
					<TR>
